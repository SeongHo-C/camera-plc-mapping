...
class WebsocketServer:
    def __init__(self):
        ...
        self.detector = Detection(self.plc_controller)
        self.camera = BasicCamera(self.detector)
    ...
    async def handle_message(self, websocket, message):
        if isinstance(message, str):
            ...
            await self.detector.file_detect(websocket, message)
